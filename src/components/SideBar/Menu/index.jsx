	...
	<nav className={styles.menu}>
		{
			mainMenu.map((item, index) => (
				<NavLink to={item.path} className={styles.navLink}>
					{({isActive}) => (
						<div className={classNames(styles.menuItem,{[styles.isActive]:isActive})}>
							<div className={styles.menuIcon}>
								{item?.notification && (<span className={styles.menuIconBg}>{item?.notification}</span>)}
								{!isActive && item.icon.inactive}
		...
		<Popover className={styles.popover}>
      		<Popover.Button className={styles.navLink}>	
      		...
      		<Popover.Panel className={styles.popoverPanel}>
				<Link to={"/i/connect_people"} className={styles.popoverItem}>
				...
				<Link to={"/settings/monetization"} className={styles.popoverItem}>
					<div className={styles.popoverIcon}>
						<svg viewBox="0 0 24 24" width={24} height={24}>
							<path
								fill='#e7e9ea'
					...
					{({ open }) => (
						<>
							<Disclosure.Button className={styles.disclosureBtn}>
								...
								<svg className={classNames(styles.disclosureIcon, {[styles.iconOpen]: open})} viewBox="0 0 24 24" width={18.75} height={18.75}>
									<path 
										fill='#e7e9ea'
							...
							<Disclosure.Panel>
								<Link to={"/home"} className={styles.disclosureItem}>
									<div className={styles.disclosureItemIcon}>
									...
									<div className={styles.disclosureItemText}>
										Analytics
									</div>
								</Link>
							</Disclosure.Panel>
				...
				<Disclosure as={'div'} className={styles.disclosure}>
					{({ open }) => (
						<>
							...
							<Disclosure.Panel>
								<Link to={"/settings"} className={styles.disclosureItem}>
									<div className={styles.disclosureItemIcon}>
										<svg viewBox="0 0 24 24" width={18.75} height={18.75}>
											<path
												fill='#e7e9ea'
								...
								<Link to={"/home"} className={styles.disclosureItem}>
									<div className={styles.disclosureItemIcon}>
										<svg className={styles.icon1} viewBox="0 0 24 24" width={18.75} height={18.75}>
											<path
												fill='#e7e9ea'
										...
										<svg className={styles.icon2} viewBox="0 0 24 24" width={18.75} height={18.75}>
											<path
												fill='#e7e9ea'
		...
		<Button type="button" size="large">Post</Button>
		</div>
	</nav>
  )
}
